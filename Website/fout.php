...
<head>
    ...
    <link href="//db.onlinewebfonts.com/c/a900db2b0a40910b1f584fbed5e438e8?family=Caecilia+LT+Std" rel="stylesheet"
        type="text/css" /> -->
    <title>Basisschool Zeebos - Fout Opgetreden</title>
</head>
...
<body>
    <header>
        <h2 class="pt-5">Er is een fout opgetreden</h2>
        <p>Het geselecteerde boek is niet beschikbaar.</p>
    ...
    <div class="container mt-4">
        <img class="img-fluid mx-auto d-block" src="https://www.elegantthemes.com/blog/wp-content/uploads/2016/03/500-internal-server-error-featured-image-1.png">
    </div>
